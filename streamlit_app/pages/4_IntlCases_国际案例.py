...
st.set_page_config(page_title="国际案例 · TT-OPC", page_icon="🌏", layout="wide")
...
for i, case in enumerate(INTL_CASES):
    with cols[i % 2]:
        metrics_html = "".join(
            f'<div style="display: inline-block; background: {case["color"]}20; color: {case["color"]}; padding: 6px 12px; border-radius: 8px; margin: 4px;"><div style="font-size: 1.15rem; font-weight: 700;">{m["value"]}</div><div style="font-size: 0.75rem;">{m["label"]}</div></div>'
...
comparison = pd.DataFrame([
    {"指标": "技术合同成交额", "美国波士顿": "2.6 亿美元/年（MIT 单机构）", "德国 Fraunhofer": "30 亿欧元/年（协会总预算）", "苏州 2024": "1050 亿元/年（全市）", "苏州判断": "✅ 已达国际水平"},
    {"指标": "概念验证中心", "美国波士顿": "20+ 家（区域型）", "德国 Fraunhofer": "80+ 家（研究所级）", "苏州 2024": "29 家", "苏州判断": "🟡 接近波士顿"},
    {"指标": "技术经纪人", "美国": "3-5 万人", "深圳 2023": "5000+ 人", "苏州 2023": "2876 人", "苏州判断": "⚠️ 落后深圳"},
    {"指标": "中试成功率", "德国 Fraunhofer": ">85%", "苏州": "未公开（估测 50-60%）", "深圳": "估测 60-70%", "苏州判断": "⚠️ 显著落后"},
    {"指标": "OPC 社区数量", "全球领先（美国）": "硅谷 YC 约 200 个", "深圳": "20+ 个（2025 年新批）", "苏州": "2025 年 11 月启动首批 20 个", "苏州判断": "🟡 起步阶段"},
    {"指标": "OPC 培育基金", "美国 YC": "标准 50 万美元/家", "深圳": "≤1000 万元/项目", "苏州": "已发布 120 个场景清单 + 100 亿新型工业化基金", "苏州判断": "✅ 资金充足"},
])
